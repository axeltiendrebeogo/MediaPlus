    ...
    <div className="home">
      ...
      <nav className="home-nav">
        <div className="home-nav-brand">
          <span className="home-brand-name">MediaPulse</span>
      ...
      <section className="hero">
        <div className="hero-inner">
          ...
          <p className="hero-desc">
            MediaPulse centralise l'analyse d'audience de vos médias en ligne. Visiteurs,
      ...
      <footer className="home-footer">
        <span className="font-semibold">MediaPulse</span>
